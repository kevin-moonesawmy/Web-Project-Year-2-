...
<head>
    ...
    .wrap{
      ...
      margin-bottom: 10%;
		...
		.slide1{background-image: url(https://topfit.qodeinteractive.com/wp-content/uploads/2017/02/about-testimonials-bckr.jpg?id=12780);}
		.slide2{background-image: url(https://topfit.qodeinteractive.com/wp-content/uploads/2017/02/about-testimonials-bckr.jpg?id=12780);}
		.slide3{background-image: url(https://topfit.qodeinteractive.com/wp-content/uploads/2017/02/about-testimonials-bckr.jpg?id=12780);}
		.slide-content{
			display: flex;
...
<div class="trainer1details" id="trainer1">
  <div class="trainer-name"><h3>John Wick</h3></div>
  <div class="introduction-align">
    ...
    <div class="testimonial">
      <div class="p1">
        <p>I’m very passionate in helping others feel good and finding happiness. I believe that when you FEEL GOOD, you do better in life.

A healthy lifestyle to me is more than lifting weights, and I always emphasize that to my clients. It’s about stretching, warming up, eating healthy and making sure your body also gets the rest and sleep it needs.

I enjoy showing others what their bodies are capable of doing with hard work.It is my ultimate goal to help you reach a happy, well-balanced lifestyle that will help minimize future health related issues.

“Whatever the mind can conceive and believe, it can achieve.” – Napolean Hill</p>
      </div>
      </div>
  </div>
...
<!------------------------trainer 1 ends here--------------------------------------------->
  ...
  <div class="trainer-name"><h3>Martin Bugaj</h3></div>
  <div class="introduction-align">
    <div class="introduction">
...
<div class="trainer3details" id="trainer3">
  <div class="trainer-name"><h3>Sarah Logan</h3></div>
  <div class="introduction-align">
    <div class="introduction">
...
<div class="trainer4details" id="trainer4">
  <div class="trainer-name"><h3>Christian Grey</h3></div>
  <div class="introduction-align">
    <div class="introduction">
...
<div class="wrap">
	  ...
	  <script>
		  let sliderText = document.querySelectorAll('.slide'),arrowLeft=document.querySelector('#arrow-left'),arrowRight=document.querySelector('#arrow-right'),current=0;
		  const textInTimer=4500,textOutTimer = 3000;
		  //clear all images
		  function reset(){
